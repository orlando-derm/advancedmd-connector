...
C1.3: `_HANDLER_MODULES` populated with the four visits actions
(3 reads + 1 write stub). The write stub is filtered from list_tools()
    ...
    *,
    ...
    for mod in _HANDLER_MODULES:
        ...
        if policy is None:
            ...
            import logging
            logging.getLogger("amd_visits_mcp.factory").warning(
