...
C3.3: `_HANDLER_MODULES` populated with the four codes actions
(all reads; no write stubs).
"""
...
from . import (
    ...
    lookup_icd10,
    lookup_modcode,
    # E4 additions per AMD_TOOLS_FULL_BUILDOUT_PLAN-final.txt + AARON-DECIDE-2 default
    # (ship as second tools because docx class=api differs from existing class=cpt/etc).
    lookupproccode,
    lookupdiagcode,
    lookupmodcode,
)
...
# Each handler module.
# E4 (2026-06-04): +3 read tools (class=api siblings).
    ...
    *,
    ...
    for mod in _HANDLER_MODULES:
        ...
        if policy is None:
            ...
            import logging
            logging.getLogger("amd_codes_mcp.factory").warning(
